...
void CIrrDeviceLinux::createKeyMap()
{
	...
	KeyMap.push_back(SKeyMap(XK_KP_Home, KEY_NUMPAD7));
	KeyMap.push_back(SKeyMap(XK_KP_Left, KEY_NUMPAD4));
	KeyMap.push_back(SKeyMap(XK_KP_Up, KEY_NUMPAD8));
	KeyMap.push_back(SKeyMap(XK_KP_Right, KEY_NUMPAD6));
	KeyMap.push_back(SKeyMap(XK_KP_Down, KEY_NUMPAD2));
	KeyMap.push_back(SKeyMap(XK_Print, KEY_PRINT));
	KeyMap.push_back(SKeyMap(XK_KP_Prior, KEY_NUMPAD9));
	KeyMap.push_back(SKeyMap(XK_KP_Page_Up, KEY_NUMPAD9));
	KeyMap.push_back(SKeyMap(XK_KP_Next, KEY_NUMPAD3));
	KeyMap.push_back(SKeyMap(XK_KP_Page_Down, KEY_NUMPAD3));
	KeyMap.push_back(SKeyMap(XK_KP_End, KEY_NUMPAD1));
	KeyMap.push_back(SKeyMap(XK_KP_Begin, KEY_NUMPAD5));
	KeyMap.push_back(SKeyMap(XK_KP_Insert, KEY_NUMPAD0));
